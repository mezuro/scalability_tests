...
public class HasSOAPProcessingAfter extends SOAPStrategy {
	...
	private ItemImpl hasSOAPProcessingAfter;

	public HasSOAPProcessingAfter() throws Exception {
	...
	public void beforeExperiment() throws Exception {
		...
		hasSOAPProcessingAfter = new ItemImpl("hasSOAPProcessingAfter");
		hasSOAPProcessingAfter.addChild("date").setContent(DATE_BEFORE);
		hasSOAPProcessingAfter.addChild("repositoryId").setContent(requestSOAPRepositoryResponse.getContent("repositoryId"));
	}

	@Override
	public Item request(Item item) throws Exception {
		return wsClient.request("hasSOAPProcessingAfter", hasSOAPProcessingAfter);
	}
