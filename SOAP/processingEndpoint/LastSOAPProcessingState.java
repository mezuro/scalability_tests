...
public class LastSOAPProcessingState extends SOAPStrategy {
	...
	public LastSOAPProcessingState() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("lastSOAPProcessingState", requestSOAPRepositoryResponse.getContent("repositoryId"));
	}
