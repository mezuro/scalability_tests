...
public class SpeedupTestRunner extends Experiment<String, String> {
	...
	public SpeedupTestRunner(RESTStrategy experimentSubject, Map<Object, Object> configParameters) throws Exception {
