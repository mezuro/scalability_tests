...
public class FirstSOAPProcessingAfter extends SOAPStrategy {
	...
	private ItemImpl firstSOAPProcessingAfter;

	public FirstSOAPProcessingAfter() throws Exception {
	...
	public void beforeExperiment() throws Exception {
		...
		firstSOAPProcessingAfter = new ItemImpl("firstSOAPProcessingAfter");
		firstSOAPProcessingAfter.addChild("date").setContent(DATE_BEFORE);
		firstSOAPProcessingAfter.addChild("repositoryId").setContent(requestSOAPRepositoryResponse.getContent("repositoryId"));
	}

	@Override
	public Item request(Item item) throws Exception {
		return wsClient.request("firstSOAPProcessingAfter", firstSOAPProcessingAfter);
	}
