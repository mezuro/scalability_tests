...
public class LastProcessing extends RESTStrategy {
	...
	public LastProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return rsClient.request("lastProcessing", requestRepositoryResponse.getContent("repositoryId"));
	}
