...
import org.mezuro.scalability_tests.REST.moduleResultEndpoint.ChildrenOf;
import org.mezuro.scalability_tests.REST.moduleResultEndpoint.GetModuleResult;
import org.mezuro.scalability_tests.REST.moduleResultEndpoint.HistoryOfModule;
...
public class ModuleResult extends Experiment<Item, Item> {
	...
	public void beforeIteration() throws Exception {
		moduleResultStrategy.setRsClient(new RSClient(getDeployer().getServiceUris("ModuleResult").get(0)));
	}
