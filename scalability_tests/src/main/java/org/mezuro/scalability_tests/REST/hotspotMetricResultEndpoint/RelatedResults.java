package org.mezuro.scalability_tests.REST.hotspotMetricResultEndpoint;
...
public class RelatedResults extends RESTStrategy {
	...
	public String request(String string) throws Exception {
		get(buildUrl(HOTSPOT_METRIC_RESULT_PATH + "/" + hotspot_metric_result_id + "/related_results"));
		return repositoryId;
	}
