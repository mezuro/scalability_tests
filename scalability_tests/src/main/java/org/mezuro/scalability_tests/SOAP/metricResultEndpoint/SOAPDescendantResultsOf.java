package org.mezuro.scalability_tests.SOAP.metricResultEndpoint;
...
public class SOAPDescendantResultsOf extends SOAPStrategy {
	...
	private final String METRIC_RESULT_WSDL = "http://10.0.0.12:8080/KalibroService/SOAPMetricResultEndpoint/?wsdl";
	...
	private Item requestSOAPMetricResultResponse;
	private ItemImpl saveSOAPRepository;
	private ItemImpl saveSOAPProject;

	public SOAPDescendantResultsOf() throws Exception {
	...
	public void beforeExperiment() throws Exception {
		...
		requestSOAPMetricResultResponse = metricResultClient.request("metricResultsOf",
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("descendantResultsOf",
			requestSOAPMetricResultResponse.getChild("metricResult").getContent("id"));
	}
