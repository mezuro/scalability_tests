...
public class SOAPHistoryOfMetric extends SOAPStrategy {
	...
	private ItemImpl historyOfMetric;

	public SOAPHistoryOfMetric() throws Exception {
	...
	public void beforeExperiment() throws Exception {
		...
		historyOfMetric = new ItemImpl("historyOfMetric");
		historyOfMetric.addChild("moduleResultId").setContent(
			requestSOAPProcessingResponse.getChild("processing").getContent("resultsRootId"));
		historyOfMetric.addChild("metricName").setContent("Lines of Code");
	}

	@Override
	public Item request(Item item) throws Exception {
		return wsClient.request("historyOfMetric", historyOfMetric);
	}
