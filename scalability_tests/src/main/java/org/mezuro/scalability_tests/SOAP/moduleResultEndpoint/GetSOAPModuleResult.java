package org.mezuro.scalability_tests.SOAP.moduleResultEndpoint;
...
public class GetSOAPModuleResult extends SOAPStrategy {
	...
	public GetSOAPModuleResult() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("getSOAPModuleResult",
