package REST.treeMetricResultEndpoint;
...
public class DescendantValues extends RESTStrategy {
	...
	public String request(String string) throws Exception {
		get(buildUrl(TREE_METRIC_RESULT_PATH + "/" + tree_metric_result_id + "/descendant_values"));
		return repositoryId;
	}
