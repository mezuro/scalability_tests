...
public class DescendantHotspotMetricResults extends RESTStrategy {
	...
	public String request(String string) throws Exception {
		get(buildUrl(MODULE_RESULT_PATH + "/" + root_module_result_id + "/descendant_hotspot_metric_results"));
		return repositoryId;
	}
