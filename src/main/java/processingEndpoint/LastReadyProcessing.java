...
public class LastReadyProcessing extends Strategy {
	...
	public LastReadyProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("lastReadyProcessing", requestRepositoryResponse.getContent("repositoryId"));
	}
