...
public class FirstProcessing extends Strategy {
	...
	public FirstProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("firstProcessing", requestRepositoryResponse.getContent("repositoryId"));
	}
