...
public class LastProcessingState extends Strategy {
	...
	public LastProcessingState() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("lastProcessingState", requestRepositoryResponse.getContent("repositoryId"));
	}
