...
public class MetricConfiguration extends Experiment<Item, Item> {
	...
	private Strategy metricConfigurationStrategy;
	private static MetricConfiguration metricConfiguration;

	public void setMetricConfigurationStrategy(Strategy metricConfigurationStrategy) {
	...
	public void beforeIteration() throws Exception {
		...
		metricConfigurationStrategy
			.setWsClient(new WSClient(getDeployer().getServiceUris("MetricConfiguration").get(0)));
	}
	...
	public static void main(String[] args) throws Exception {
		...
		metricConfiguration.setDeployer(new KalibroDeployer());
