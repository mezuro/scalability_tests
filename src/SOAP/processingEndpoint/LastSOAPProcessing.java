...
public class LastSOAPProcessing extends SOAPStrategy {
	...
	public LastSOAPProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("lastSOAPProcessing", requestSOAPRepositoryResponse.getContent("repositoryId"));
	}
