...
public class HasSOAPProcessing extends SOAPStrategy {
	...
	public HasSOAPProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("hasSOAPProcessing", requestSOAPRepositoryResponse.getContent("repositoryId"));
	}
