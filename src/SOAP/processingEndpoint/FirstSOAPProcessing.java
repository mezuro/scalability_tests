...
public class FirstSOAPProcessing extends SOAPStrategy {
	...
	public FirstSOAPProcessing() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("firstSOAPProcessing", requestSOAPRepositoryResponse.getContent("repositoryId"));
	}
