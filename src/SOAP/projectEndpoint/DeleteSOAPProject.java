...
public class DeleteSOAPProject extends SOAPStrategy {
	...
	public DeleteSOAPProject(int requestsPerStep) throws Exception {
	...
	public void beforeStep() throws Exception {
		for (int cont = 0; cont < requestsPerStep; cont++) {
			...
			idList.push(projectClient.request("saveSOAPProject", saveSOAPProject).getContent("projectId"));
		}
	}

	@Override
	public Item request(Item item) throws Exception {
		return wsClient.request("deleteSOAPProject", idList.pop());
	}

	@Override
	public void afterRequest(Item requestResponse) throws Exception {
		if (! requestResponse.getName().equals("deleteSOAPProjectResponse"))
			step++;
	}
