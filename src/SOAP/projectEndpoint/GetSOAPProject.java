...
public class GetSOAPProject extends SOAPStrategy {
	...
	public GetSOAPProject() throws Exception {
	...
	public Item request(Item item) throws Exception {
		return wsClient.request("getSOAPProject", requestResponse.getContent("projectId"));
	}
